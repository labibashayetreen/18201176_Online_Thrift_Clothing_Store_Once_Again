...
<?php $__env->startSection('main-content'); ?>
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="<?php echo e(route('shipping.create')); ?>" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Shipping</a>
    </div>
    <div class="card-body">
          ...
          <tbody>
            <?php $__currentLoopData = $shippings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shipping): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
                <tr>
                    ...
                    <td>$<?php echo e($shipping->price); ?></td>
                    <td>
                    ...
                    <td>
                        <a href="<?php echo e(route('shipping.edit',$shipping->id)); ?>" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                        <form method="POST" action="<?php echo e(route('shipping.destroy',[$shipping->id])); ?>">
                          <?php echo csrf_field(); ?> 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Desktop\470 Projectt\resources\Views/backend/shipping/index.blade.php ENDPATH**/ ?>