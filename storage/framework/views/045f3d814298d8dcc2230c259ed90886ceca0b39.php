...
<?php $__env->startSection('Once Again','Checkout page'); ?>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="country" id="country">
                                                ...
                                                <option value="AX">Chittagong</option>
                                                <option value="AL">Rangpur</option>
                                                <option value="DZ">Khulna</option>
                                                <option value="AS">Rajshahi</option>
                                                <option value="AD">Barishal</option>
                                                <option value="AO">Mymensingh</option>
                                                <option value="AI">Sylhet</option>
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <ul>
                                            ...
                                            <li class="shipping">
                                                ...
                                                <?php if(count(Helper::shipping())>0 && Helper::cartCount()>0): ?>
                                                    <select name="shipping" class="nice-select">
                                                        ...
                                                        <option value="<?php echo e($shipping->id); ?>" class="shippingOption" data-price="<?php echo e($shipping->price); ?>"><?php echo e($shipping->type); ?>: $<?php echo e($shipping->price); ?></option>
                                            ...
                                            <li class="coupon_price" data-price="<?php echo e(session('coupon')['value']); ?>">You Save<span>$<?php echo e(number_format(session('coupon')['value'],2)); ?></span></li>
                                            <?php endif; ?>
                                            <?php
                                            ...
                                            ?>
                                            <?php if(session('coupon')): ?>
                                                <li class="last"  id="order_total_price">Total<span>$<?php echo e(number_format($total_amount,2)); ?></span></li>
                                            <?php else: ?>
                                                <li class="last"  id="order_total_price">Total<span>$<?php echo e(number_format($total_amount,2)); ?></span></li>
                                            <?php endif; ?>
                                        </ul>
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <form-group>
												...
												<input name="payment_method"  type="radio" value="paypal"> <label> Card</label> <br>
                                                <input name="payment_method"  type="radio" value="paypal"> <label> Bkash</label> <br>
												<input name="payment_method"  type="radio" value="paypal"> <label> Nogod</label><br>
												<input name="payment_method"  type="radio" value="paypal"> <label> Rocket</label>
                                            </form-group>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Desktop\470FinalProject\resources\Views/frontend/pages/checkout.blade.php ENDPATH**/ ?>