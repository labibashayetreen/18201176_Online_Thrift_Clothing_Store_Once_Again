...
<?php $__env->startSection('main-content'); ?>
						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									?>
									<h4>Get in touch</h4>
									<h3>Write us a message <?php if(auth()->guard()->check()): ?> <?php else: ?><span style="font-size:12px;" class="text-danger">[You need to login first]</span><?php endif; ?></h3>
								</div>
	...
	<div class="map-section">
		<div id="myMap">
			<iframe src="https://www.google.com/maps/d/viewer?ie=UTF8&hl=en&msa=0&ll=24.206890000000012%2C90.94482400000001&spn=7.010723%2C9.338379&z=6&source=embed&mid=12Gwhw81QpfUErMIYE8fl5tQNqZs" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
		</div>
	</div>
	<!--/ End Map Section -->
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Desktop\470FinalProject\resources\Views/frontend/pages/contact.blade.php ENDPATH**/ ?>