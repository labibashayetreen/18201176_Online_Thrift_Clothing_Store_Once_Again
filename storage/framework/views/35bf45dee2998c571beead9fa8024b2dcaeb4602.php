				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							<div class="logo">
								<a href="index.html"><img src="<?php echo e(asset('backend/img/logo.png')); ?>" alt="#"></a>
							</div>
							<?php
								$settings=DB::table('settings')->get();
							?>
							<p class="call">Contact At<span><a href="tel:0176557384"><?php $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($data->phone); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></a></span></p>
						</div>
						<!-- End Single Widget -->
					</div>
					...
					<div class="col-lg-3 col-md-6 col-12">
						...
						<div class="single-footer social">
							<h4>Online Dhaka Based</h4>
							<h4>Delivery All Over Bangladesh</h4>
				...
				<div class="inner">
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="left">
								<p>Copyright © <?php echo e(date('Y')); ?> <a href="https://github.com/labibashayetreen" target="_blank">Labiba Shayetreen</a>  -  All Rights Reserved.</p>
							</div>
						</div>
						<div class="col-lg-6 col-12">
							<div class="right">
	...
	<script>
	  ...
	  </script><?php /**PATH C:\Users\hp\Desktop\470FinalProject\resources\Views/frontend/layouts/footer.blade.php ENDPATH**/ ?>