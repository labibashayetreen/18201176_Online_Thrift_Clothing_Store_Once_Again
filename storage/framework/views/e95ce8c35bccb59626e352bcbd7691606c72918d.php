...
<?php $__env->startSection('title','Once Again|| PRODUCT PAGE'); ?>
                                    ...
                                    <?php $__currentLoopData = $recent_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                ...
                                                ?>
                                                <p class="price"><del class="text-muted">$<?php echo e(number_format($product->price,2)); ?></del>   $<?php echo e(number_format($org,2)); ?>  </p>                                                
                                            </div>
                                        </div>
                                        <!-- End Single Post -->
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											...
											<div class="row">
												...
												<div class="col-lg-8 col-md-6 col-12">
													<div class="list-content">
														...
														<a href="javascript:void(0)" class="btn cart" data-id="<?php echo e($product->id); ?>">Buy Now!</a>
													</div>
												</div>
											</div>
										</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Desktop\470FinalProject\resources\Views/frontend/pages/product-lists.blade.php ENDPATH**/ ?>